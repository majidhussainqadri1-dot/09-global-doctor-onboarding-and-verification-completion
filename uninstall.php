...
$tables = array( 'applications','evidence','transitions','consents','access_log','appeals','outbox','rate_limits','reviewer_profiles','risk_signals','quality_samples','access_grants','metrics' );
...
$options = array( 'gdo_page_map','gdo_version','gdo_schema_version','gdo_activation_evidence','gdo_migration_lock','gdo_safe_mode','gdo_allow_destructive_uninstall','gdo_destructive_uninstall_confirmation' );
