...
'includes/class-gdo-evidence.php':['stage_upload','gdo_credential_scan_result','access_grants','watermark','delete_record_safely','deletion_proof'],
...
'includes/class-gdo-privacy.php':['wp_privacy_personal_data_exporters','legal_hold','GDO_Evidence::delete_record_safely'],
