...
for token in ['Version: 1.3.0',"define( 'GDO_VERSION', '1.3.0' );","define( 'GDO_SCHEMA_VERSION', 6 );","define( 'GDO_CF01_PRACTITIONER_CONTRACT_VERSION', '1.0.0' );"]:
