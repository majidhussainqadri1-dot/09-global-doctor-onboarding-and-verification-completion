...
check(75,'Erasure covers application-scoped Advanced Trust derivatives',has(privacy,'GDO_Advanced_Trust_Hardening::privacy_erase_application') and 'verification_passports' in hard[hard.index('public static function privacy_erase_application'):hard.index('private static function rest_value')] and ('checked_delete' in hard[hard.index('public static function privacy_erase_application'):hard.index('private static function rest_value')] or '$wpdb->delete' in hard[hard.index('public static function privacy_erase_application'):hard.index('private static function rest_value')]))
