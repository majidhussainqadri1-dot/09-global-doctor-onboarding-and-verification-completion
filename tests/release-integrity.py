...
if lock.get('runtime')!='1.3.0' or lock.get('schema')!=6 or lock.get('advanced_trust_schema')!=2 or lock.get('advanced_trust_contract')!='1.1.0' or lock.get('release_candidate')!='RC6' or lock.get('review_rounds')!=80 or lock.get('defect_rounds')!=49 or lock.get('second_review_rounds')!=80 or lock.get('second_defect_rounds')!=47 or lock.get('second_clean_rounds')!=33 or lock.get('second_review_baseline')!='c3fbbadbee06d2be13b23822f5f17fce07cdab4e' or lock.get('third_review_rounds')!=80 or lock.get('third_defect_rounds')!=13 or lock.get('third_clean_rounds')!=67 or lock.get('third_review_baseline')!='f1901a2326ddf1189b90a5f34f8bbcc7e6eb0361' or lock.get('release_file_count')!=len(release_files): fail('release lock mismatch')
...
for p in ['includes/class-gdo-advanced-trust.php','includes/class-gdo-advanced-trust-hardening.php','includes/class-gdo-advanced-trust-events.php','ADVANCED-TRUST-24.md','REVIEW-80-ROUNDS-RC6.md','REVIEW-80-ROUNDS-RC6-R2.md','REVIEW-80-ROUNDS-RC6-R3.md']:
